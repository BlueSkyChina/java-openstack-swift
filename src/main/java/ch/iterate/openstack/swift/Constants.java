...
/**
 * 各种swift RestFul交互中的http header中的值
 * 
 * @author mlchen@iflytek.com
 * 
 */
public class Constants {
	...
	/**
	 * HTTP header token that identifies the Storage URL after a successful user
	 * login
	 */
	public static final String X_STORAGE_URL = "X-Storage-Url";
	/**
	 * HTTP header that identifies the CDN Management URL after a successful
	 * login
	 */
	public static final String X_CDN_MANAGEMENT_URL = "X-CDN-Management-URL";
	/**
	 * HTTP header token that identifies the Storage Token after a successful
	 * user login
	 */
	 ...
	 * The value of this header is /<sourcecontainer>/<sourceobject>
	 */
	...
	public static final List<String> HTTP_HEADER_EDITABLE_NAMES = Arrays
			.asList(MANIFEST_HEADER.toLowerCase(Locale.ENGLISH),
